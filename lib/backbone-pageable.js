        ...
        if (event == "remove") {
          if (!options.onAdd) {
            ...
            if (!--state.totalRecords) {
              ...
              state.lastPage = firstPage === 0 ? totalPages - 1 : max(1, totalPages);
    ...
    */
    _checkState: function (state) {
      ...
      if (totalRecords != null && pageSize != null && currentPage != null &&
        ...
        state.lastPage = firstPage === 0 ? max(0, totalPages - 1) : max(1, totalPages);
    ...
    */
    switchMode: function (mode, options) {
      ...
      if (mode == "infinite") {
        ...
        var lastPage = firstPage === 0 ? max(0, totalPages - 1) : max(1, totalPages || firstPage);
