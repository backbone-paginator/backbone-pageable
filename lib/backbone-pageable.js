        ...
        if (event == "remove") {
          if (!options.onAdd) {
            ...
            if (collection == pageCol) {
              ...
              if (pageCol.length == 0 && pageCol.state.totalRecords > 0)
                pageCol.reset(fullCol.models.slice((pageCol.state.currentPage-pageCol.state.firstPage)*pageCol.state.pageSize),pageSize, _.extend({}, options, {parse: false}));
            }
          }
